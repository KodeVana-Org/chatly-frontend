...
export default function UserInfo({
  ...
  return (
    <>
      ...
      {/* Show this Above LG */}
      <div className="lg:border-l hidden lg:flex flex-col h-full border-stroke dark:border-strokedark">
        ...
        <div className="flex flex-col gap-3 px-2">
          ...
          {!isGroup && (
            <span className="text-body text-md">
              {user?.jobTitle || "No job selected"}
            </span>
          )}
        </div>
        {/* Message Scheduler */}
        <div className="m-1 p-2 border border-stroke dark:border-strokedark rounded-sm">
          <h3 className="text-black dark:text-white font-medium text-lg mb-2">
            Schedule a Message
          </h3>
          <textarea
        ...
        {scheduledMessages.length > 0 && (
          <div className="m-1 p-2 border border-stroke dark:border-strokedark rounded-sm">
            <h4 className="text-black dark:text-white font-semibold text-md mb-2">
              Scheduled Messages
            </h4>
            <ul
                ...
                .map((msg) => (
                  ...
                  >
                    <div>
                      ...
                      <span>- {formatDateTime(msg.sendAt)}</span>
                    </div>
                    <button
                      onClick={() =>
                      ...
                      className="px-2 py-1 bg-rose-500 text-black dark:text-white rounded hover:bg-rose-600"
                    >
                      Cancel
                    </button>
                  </li>
